...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			"megaport_aws_connection": {Tok: tfbridge.MakeResource(mainPkg, aws, "connection")},
			"megaport_gcp_connection": {Tok: tfbridge.MakeResource(mainPkg, gcp, "connection")},
			"megaport_mcr":            {Tok: tfbridge.MakeResource(mainPkg, cloudRouter, "router")},
			"megaport_port":           {Tok: tfbridge.MakeResource(mainPkg, port, "port")},
			"megaport_vxc":            {Tok: tfbridge.MakeResource(mainPkg, vxc, "connection")},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			"megaport_aws_connection":   {Tok: tfbridge.MakeDataSource(mainPkg, aws, "getConnection")},
			"megaport_azure_connection": {Tok: tfbridge.MakeDataSource(mainPkg, azure, "getConnection")},
			"megaport_gcp_connection":   {Tok: tfbridge.MakeDataSource(mainPkg, gcp, "getConnection")},
			...
			"megaport_vxc":              {Tok: tfbridge.MakeDataSource(mainPkg, vxc, "getConnection")},
		},
